...
namespace SenacNivelamento.Api.Controllers
{
    ...
    {
        public FuncionarioController(IMediator mediator) : base(mediator)
        {
        }

        [HttpPost]
        public async Task<IActionResult> Post([FromBody] CreateFuncionarioCommand request)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] UpdateFuncionarioCommand request)
        {
            var response = await _mediator.Send(request);
        ...
        {
            var query = new BuscarFuncionarioPorIdQuery
            {
                Id = id
            };
        ...
        {
            var query = new BuscarFuncionarioQuery();
        ...
        {
            var command = new DeleteFuncionarioCommand
            {
                Id = id
            };
        ...
        public async Task<ActionResult<object>> PostImagem([FromForm(Name = "imagem")] IFormFile imagem, long id)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(urlImagem))
                {
                    ...
                    var command = new UpdateFuncionarioImagemCommand()
                    {
                        Id = id,
                        Imagem = urlImagem
                    };
